...
class SeriesMetadataViewTests(TestCase):
    ...
    def test_film_returns_no_series(self):
        payload = {"type": "Film"}
        resp = self.post_json({
            "source_alias": "streamingcommunity",
    ...
    @patch("StreamingCommunity.Api.Site.streamingcommunity.util.ScrapeSerie.GetSerieInfo")
    @patch("StreamingCommunity.Util.config_json.config_manager.get_site", return_value="https://example.com")
